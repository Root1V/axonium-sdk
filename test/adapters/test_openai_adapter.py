...
class TestOpenAIAdapter:
    @patch('axonium.adapters.open_ai_adapter.AuthHttpClientFactory')
    @patch('axonium.adapters.open_ai_adapter.OpenAI')
    ...
    def test_init_with_custom_base_url(self, mock_openai_class):
        with patch('axonium.adapters.open_ai_adapter.AuthHttpClientFactory') as mock_auth_factory:
